...
// push - добавить в конце, shift - удалить в начале
// 1 Шелдон, Леонард, Пенни, Раджеш, Говард -> Шелдон
// 2 Леонард, Пенни, Раджеш, Говард, Шелдон, Шелдон -> Леонард
// 3 Пенни, Раджеш, Говард, Шелдон, Шелдон, Леонард, Леонард -> Пенни

function doubleCola(n) {
    //TODO
    var friends = ["Sheldon", "Leonard", "Penny", "Radgesh", "Howard"];
    for (let i = 0; i < n ; i++) {
        var deleteFriend = friends.shift();
        friends.push(deleteFriend, deleteFriend);
    }
    return deleteFriend;
